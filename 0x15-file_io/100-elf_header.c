 ...
 * @e_ident: pointer to an array containing the ELF magic num
 * Return: void
 */
void check_elf(unsigned char *e_ident)
{
...
/**
 * print_magic - function to print the magic nums of an ELF header
 * @e_ident: pointer to an array containing the ELF magic num
 * Description: Magic nums are separated by space
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_class - function to print class of an ELF header
...
/**
 * print_entry - functon to print the entry point of an ELF header
 * @e_ident: pointer to an array containing the ELF class
